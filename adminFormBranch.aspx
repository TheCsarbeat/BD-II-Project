               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBoxIDLugar" runat="server" placeholder="ID Place" ></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <label>idCoinXCountry</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBoxIdMonedaXP" runat="server" placeholder="idCoinXCountry" ></asp:TextBox>
                        </div>
                     </div>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                          ConnectionString="<%$ ConnectionStrings:connectionFernanda %>" SelectCommand="exec spSelectSucursalesToView"></asp:SqlDataSource>
                     <div class="col">
